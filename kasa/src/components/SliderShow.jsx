...
function Slideshow({slides}){
    ...
    return(
        <>
            {slidesLength > 1 && <span className='carousel_fraction'>{currentPicture +1}/{slidesLength}</span>}
            {slidesLength > 1 && <div className='carousel_arrows'>
                <img 
                    src={arrowLeft} 
                    alt='photo précédente'
                    className='carousel_arrows_left'
                    onClick={previousPicture}
                />
                <img 
                    src={arrowRight} 
                    alt='photo suivante'
                    className='carousel_arrows_right'
